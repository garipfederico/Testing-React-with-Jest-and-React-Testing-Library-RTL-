...
export function useOrderDetails() {
  ...
  if (!contextValue)
    throw new Error(
      'useOrderDetails must be called from within a OrderDetails',
    );
  return contextValue;
}
...
export function OrderDetailsProvider(props) {
  ...
  // utility funtion to  derive total from optionCounts state value
  function calculateTotal(optionType) {
    // get an array of counts for the option type ( for examplw , [1, 2])
